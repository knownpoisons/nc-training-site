...
**Open items for Jem** (carried): confirm PROOF `$50k` edit; Beehiiv Brand Kit + paste-test; sanity-check first real dossiers; optionally set `DECK_PASSWORD`; **start the dry-run week** — add 6 real prospects in #cockpit; **deploy the two /library finders when happy**.
