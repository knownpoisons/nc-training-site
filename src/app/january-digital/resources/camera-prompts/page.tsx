...
export const metadata: Metadata = {
  title: "The Camera Prompt Finder — January Digital × NotContent",
  ...
  return (
    <div className="library">
      ...
      <section className="cm-choose" aria-label="Choose a finder">
        <Link href="/january-digital/resources/camera-prompts/movements" className="cm-choice">
        ...
        <Link href="/january-digital/resources/camera-prompts/angles" className="cm-choice">
          <div className="cm-choice-media">
            <AngleDiagram
              slug="medium-shot"
