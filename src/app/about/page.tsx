          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {differentiators.map((diff, i) => (
              <Reveal key={diff.title} delay={i * 80}>
                <div className="nc-card-hover border border-background/20 p-8 transition-colors hover:border-background/30">
                  <ServiceIcon
                    icon={diff.icon}
                    size={32}
      ...
      <section className="nc-divider nc-section">
        <div className="nc-container">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            {press.map((item, i) => (
              <Reveal key={item.outlet} delay={i * 80}>
                <a
                  href={item.href}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="nc-card-hover group block border border-foreground/10 p-6 transition-colors hover:bg-foreground hover:text-background"
                >
