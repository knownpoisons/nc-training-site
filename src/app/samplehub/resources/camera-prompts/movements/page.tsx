...
export const metadata: Metadata = {
  title: "Camera Movements — SKYNET × NotContent",
  description:
...
export default function JdCameraMovementsPage() {
  ...
  return (
    <div className="library">
      ...
      <section className="hero">
        <div className="eyebrow">
          <span>
            ...
            &nbsp;/&nbsp;{" "}
            <Link href="/samplehub/resources/camera-prompts" className="cm-breadcrumb">
              Camera Prompts
            </Link>{" "}
            · AI Video
          </span>
      ...
      <JdCrosslink
        href="/samplehub/resources/camera-prompts/angles"
