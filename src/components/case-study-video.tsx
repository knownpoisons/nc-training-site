    ...
    >
      ...
      {!reduced && !needsControls && (
        <button
          ...
          className="absolute bottom-3 right-3 flex items-center gap-1.5 bg-black/55 backdrop-blur-sm text-white text-[10px] uppercase tracking-[0.15em] px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity"
        >
